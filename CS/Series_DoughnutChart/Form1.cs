...
namespace Series_DoughnutChart {
    public partial class Form1 : Form {
        ...
        private void Form1_Load(object sender, EventArgs e) {
            ...
            // Adjust the value numeric options of the series labels.          
            ((DoughnutSeriesLabel)series1.Label).PointOptions.ValueNumericOptions.Format = NumericFormat.Percent;
            ((DoughnutSeriesLabel)series1.Label).PointOptions.ValueNumericOptions.Precision = 0;
            ...
            ((DoughnutSeriesLabel)series1.Label).PointOptions.PointView = PointView.ArgumentAndValues;
